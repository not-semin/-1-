...
```{r warning=FALSE, message=FALSE}
set.seed(2024311134)
mi_1000_1_10 <- multiple_imputation(sampled_data = sampling_1000_1, m = 10)
cox_1000_1_10 <- coxph_function(imputed_data_list = mi_1000_1_10$imputed_datasets)
result_1000_1_10 <- result_function(beta_results = cox_1000_1_10)
print(result_1000_1_10$results1)
```
**1:3**
```{r warning=FALSE, message=FALSE}
set.seed(2024311134)
...
```{r warning=FALSE, message=FALSE}
set.seed(2024311134)
mi_1000_3_10 <- multiple_imputation(sampled_data = sampling_1000_3, m = 10)
cox_1000_3_10 <- coxph_function(imputed_data_list = mi_1000_3_10$imputed_datasets)
result_1000_3_10 <- result_function(beta_results = cox_1000_3_10)
print(result_1000_3_10$results1)
```
...
```{r warning=FALSE, message=FALSE}
set.seed(2024311134)
mi_1000_5_10 <- multiple_imputation(sampled_data = sampling_1000_5, m = 10)
cox_1000_5_10 <- coxph_function(imputed_data_list = mi_1000_5_10$imputed_datasets)
result_1000_5_10 <- result_function(beta_results = cox_1000_5_10)
print(result_1000_5_10$results1)
```