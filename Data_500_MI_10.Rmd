...
```{r warning=FALSE, message=FALSE}
set.seed(2024311134)
mi_500_1_10 <- multiple_imputation(sampled_data = sampling_500_1, m = 10)
cox_500_1_10 <- coxph_function(imputed_data_list = mi_500_1_10$imputed_datasets)
result_500_1_10 <- result_function(beta_results = cox_500_1_10)
print(result_500_1_10$results1)
```
...
```{r warning=FALSE, message=FALSE}
set.seed(2024311134)
mi_500_3_10 <- multiple_imputation(sampled_data = sampling_500_3, m = 10)
cox_500_3_10 <- coxph_function(imputed_data_list = mi_500_3_10$imputed_datasets)
result_500_3_10 <- result_function(beta_results = cox_500_3_10)
print(result_500_3_10$results1)
```
...
```{r warning=FALSE, message=FALSE}
set.seed(2024311134)
mi_500_5_10 <- multiple_imputation(sampled_data = sampling_500_5, m = 10)
cox_500_5_10 <- coxph_function(imputed_data_list = mi_500_5_10$imputed_datasets)
result_500_5_10 <- result_function(beta_results = cox_500_5_10)
print(result_500_5_10$results1)
```
